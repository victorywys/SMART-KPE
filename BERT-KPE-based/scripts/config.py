...
def add_default_args(parser):
    ...
    files.add_argument("--snapshot_path", type=str, default=None,
                       help="Path to snapshot vectors.")
    ...
    optim.add_argument("--learning_rate", default=1e-5, type=float,
...
def init_args_config(args):
    ...
    # principle folder
    print(f"this is the thread with local rank: {args.local_rank}")
